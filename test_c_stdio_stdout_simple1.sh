...
qq xstatic gcc -m32 -Os -W -Wall -s -Werror=implicit-function-declaration -nostdlib -nostdinc -o test_c_stdio_stdout_simple1.prog demo_c_hello.c printf_callvf.o vfprintf_noplus.o c_stdio_stdout_simple1.c write_linux.o start_stdio_nomini_linux.o
