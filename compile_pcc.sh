...
# upx.pts --small --brute --no-lzma -f -o tools/pts-pcc ../pts-pcc/pccbin/pcc  # Tries more option, smaller.
upx.pts --small --best --no-lzma --nrv2e --filter=0x49 -q -q -f -o tools/pts-pcc ../pts-pcc/pccbin/pcc  # Tries 3 options only.
