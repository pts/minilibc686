...
qq xstatic gcc -m32 -Os -W -Wall -Werror=implicit-function-declaration -nostdlib -nostdinc -s -o test_c_stdio_stdout_simple2.prog test_printf.c printf_callvf.o vfprintf_noplus.o c_stdio_stdout_simple2.c write_linux.o start_stdio_linux.o
