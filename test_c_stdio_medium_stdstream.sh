...
ARGS="-D__MINILIBC686__ -m32 -Os -W -Wall -s -Werror=implicit-function-declaration -ffreestanding -Iinclude -nostdlib -nostdinc -pedantic c_stdio_medium_rest.c c_stdio_medium_for_printf.c test_stdstream.c stdio_medium_vfprintf.o printf_callvf.o fprintf_callvf.o stdio_medium_getchar.o stdio_medium_putchar.o start_stdio_medium_linux.o stdio_medium_init_isatty.o isatty_linux.o stdio_medium_flushall.o stdio_medium_stdin.o stdio_medium_stdout.o stdio_medium_stderr.o"
