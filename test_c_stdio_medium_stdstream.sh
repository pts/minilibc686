...
ARGS="-m32 -Os -W -Wall -s -Werror=implicit-function-declaration -Iinclude -nostdlib -nostdinc -pedantic c_stdio_medium.c test_stdstream.c stdio_medium_vfprintf.o printf_callvf.o fprintf_callvf.o stdio_medium_stdout.o stdio_medium_stderr.o start_stdio_file_linux.o"
