...
qq gcc -nostdlib -nostdinc -Iinclude -m32 -Os -W -Wall -s -o test_lseek64_linux.prog test_lseek64.c lseek64_linux.o m_flushall_dummy.o start_stdio_file_nomini_linux.o
