...
;
; Code+data size: !! bytes for i686, +1 bytes for i386.
;
...
mini_optind:	dd 1
mini_opterr:	dd 1
getopt.error1:	db 'Unknown option `-x', 39, '.', 10, 0
getopt.error2:	db 'Missing argument for `-x', 39, '.', 10, 0
