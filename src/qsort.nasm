...
; sort/sort_insertion_sort.c. Then a few small optimizations were done.
;
; Same signature as qsort(3), but it implements insertion sort instead in
; compact (short) code. It is stable.
;
