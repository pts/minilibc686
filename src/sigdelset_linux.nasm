...
; Compile to i386 ELF .o object: nasm -O999999999 -w+orphan-labels -f elf -o sigdelset_linux.o sigdelset_linux.nasm
;
...
section .text
mini_sigdelset:  ; int mini_sigdelset(sigset_t *set, int signum);
