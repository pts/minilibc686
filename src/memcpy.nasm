...
global mini_memcpy
global __builtin_memcpy  ; `call __builtin_memcpy' generated by our patched GCC 4.1.2 and 4.2.1 for struct assignments. minicc.sh calls them as `cc1 -fobjc-direct-dispatch'.
