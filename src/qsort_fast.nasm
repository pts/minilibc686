...
;
; Code size, including memswap: 0xd0 bytes for i686, 0xd1 bytes for i386. !!
;
...
; !! TODO(pts): Make this shorter.
static_mini_memswap:  ; void static_mini_memswap(void *a, void *b, size_t size);
		push esi
		mov esi, ecx
		push ebx
		xor ebx, ebx
