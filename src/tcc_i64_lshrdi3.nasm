...
; Compile to i386 ELF .o object: nasm -O999999999 -w+orphan-labels -f elf -o tcc_i64_lshrdi3.o tcc_i64_lshrdi3.nasm
;
...
__lshrdi3:  ; unsigned long long __lshrdi3(unsigned long long a, int b) { return a >> b; }
; For TinyCC 0.9.26.
