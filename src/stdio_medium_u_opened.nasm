...
; Compile to i386 ELF .o object: nasm -O999999999 -w+orphan-labels -f elf -o stdio_medium_u_opened.o stdio_medium_u_opened.nasm
;
...
; phase.
dd mini___M_call_start_flush_opened
