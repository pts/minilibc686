...
my @gcc_flags = qw(-m32 -fno-pic -Os -W -Wall -Werror -U_FORTIFY_SOURCE -fno-stack-protector -fno-unwind-tables -fno-asynchronous-unwind-tables -falign-functions=1 -falign-jumps=1 -falign-loops=1 -mpreferred-stack-boundary=2 -fno-builtin -fno-ident -fsigned-char -ffreestanding -mno-align-double -mincoming-stack-boundary=4);
