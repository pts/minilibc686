...
int main(int argc, char **argv) {
  ...
  if (mini_strncmp("A", "a", 1) >= 0) return 97;
  if (mini_strncmp("a", "A", 1) <= 0) return 96;
  if (mini_strncmp("foo", "food", 2) != 0) return 94;
  if (mini_strncmp("foo", "food", 3) != 0) return 93;
  if (mini_strncmp("foo", "food", 4) >= 0) return 92;
  if (mini_strncmp("food", "foo", 4) <= 0) return 91;
  ...
  if (mini_strncmp("foo\0x", "food", 4) >= 0) return 85;
  if (mini_strncmp("fool", "foo\0d", 3) != 0) return 84;
  if (mini_strncmp("fool", "foo\0d", 4) <= 0) return 83;
  if (mini_strncmp("foolx", "food", 3) != 0) return 82;
  if (mini_strncmp("foolx", "food", 4) <= 0) return 81;
  return 0;
}
