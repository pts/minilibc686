...
qq xstatic gcc -m32 -Os -W -Wall -s -Werror=implicit-function-declaration -nostdlib -nostdinc -o test_c_stdio_file_simple_buffered.prog c_stdio_file_simple_buffered.c test_file_simple_copy.c start_stdio_file_linux.o
